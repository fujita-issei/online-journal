...
describe("MonthToDoのテスト", () => {
    ...
    it("ToDoを書いたり、重要度を変えたり、チェックボックスを押したら、それぞれのdispatchが呼ばれる", () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith(
            expect.objectContaining({
                type: "monthJournal/changeMonthToDo",
        ...
        expect(mockDispatch).toHaveBeenCalledWith(
            expect.objectContaining({
                type: "monthJournal/changeMonthToDoImportant",
        ...
        expect(mockDispatch).toHaveBeenCalledWith(
            expect.objectContaining({
                type: "monthJournal/toggleMonthToDoCheck",
                payload: 0
            })
        )
    })
    ...
    it("ToDoの削除ボタンを押したら、消えるdispatchが呼ばれる", () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith(
            expect.objectContaining({
                type: "monthJournal/deleteMonthToDo",
                payload: 1
            })
        )
    })
