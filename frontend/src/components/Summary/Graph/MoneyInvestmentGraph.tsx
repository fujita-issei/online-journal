...
const MoneyInvestmentGraph = ({ investmentData }: Props) => {
                ...
                >
                    ...
                    <Tooltip 
                        ...
                        formatter={(value: number | undefined) => {
                            ...
                            if (value === undefined) return ["", "投資額"];
                            return [`${value.toLocaleString()} 円`, "投資額"];
                        }}
...
export default MoneyInvestmentGraph;