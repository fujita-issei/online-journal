...
const MoneyUseSumGraph = ({ useSumData }: Props) => {
                ...
                >
                    ...
                    <Tooltip 
                        ...
                        formatter={(value: number | undefined) => {
                            ...
                            if (value === undefined) return ["", "合計金額"];
                            return [`${value.toLocaleString()} 円`, "合計金額"];
                        }}
...
export default MoneyUseSumGraph;