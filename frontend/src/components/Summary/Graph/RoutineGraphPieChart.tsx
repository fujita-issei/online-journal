...
const RoutineGraphPieChart = () => {

    const { routineSummary } = useAppSelector((state) => state.summary)
    ...
    // 3. グラフ用のデータを作成
    const pieData = [
        { name: '完了', value: routineSummary.routineDone },
        { name: '未完了', value: routineSummary.routineAll - routineSummary.routineDone },
    ];
    ...
    return (
        <div className="w-full h-48 mt-4 relative">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                    ...
                    `}>
                        {routineSummary.routineAll === 0 
                            ? 0 
                            : Math.round((routineSummary.routineDone / routineSummary.routineAll) * 100)
...
export default RoutineGraphPieChart