...
describe("WeekToDoのテスト", () => {
    ...
    it("ToDoを書いたり、重要度を変えたり、チェックボックスを押したら、それぞれのdispatchが呼ばれる", () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith(
            expect.objectContaining({
                type: "weekJournal/changeWeekToDo",
        ...
        expect(mockDispatch).toHaveBeenCalledWith(
            expect.objectContaining({
                type: "weekJournal/changeWeekToDoImportant",
        ...
        expect(mockDispatch).toHaveBeenCalledWith(
            expect.objectContaining({
                type: "weekJournal/toggleWeekToDoCheck",
                payload: 0
            })
        )
    })
    ...
    it("ToDoの削除ボタンを押したら、消えるdispatchが呼ばれる", () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith(
            expect.objectContaining({
                type: "weekJournal/deleteWeekToDo",
                payload: 1
            })
        )
    })
