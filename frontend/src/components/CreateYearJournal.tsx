...
import YearNavi from "./YearJournal/YearNavi"
import YearTodo from "./YearJournal/YearTodo"
import YearJournal from "./YearJournal/YearJournal"
import YearSummary from "./YearJournal/YearSummary"
import axios from "axios"
import { changeYearDate, setYearInit } from "../store/yearJournal"

const CreateYearJournal = () => {

    const dispatch = useAppDispatch()
    const [ reset, setReset ] = useState(false)
    const { targetDate } = useAppSelector((state) => state.yearJournal)
    ...
    return (
        <div>
            ...
            <div className = {`mt-4 border-2 mx-3 py-6 px-3 rounded-2xl shadow-lg bg-white border-dashed ${selectedColor !== "pink" && "border-gray-500"} ${selectedColor == "pink" && "border-pink-500"}`}>
                ...
                <YearTodo />
                <YearJournal />
                <YearSummary renderingTrigger = {renderingTrigger} />
            ...
            >
                ...
                >
                    <p className = "mb-1">{targetDate}年の</p>
...
export default CreateYearJournal